...
public class DebugFormatTest {
  ...
  protected static final String UNSTABLE_PREFIX_SINGLE_LINE = getUnstablePrefix(true);
  protected static final String UNSTABLE_PREFIX_MULTILINE = getUnstablePrefix(false);
